...
urlpatterns = [
    ...
    url(r'^assignments/(?P<pk>\d+)/validity_testscript/$', frontend.ValidityScriptView.as_view(),
        name='validity_script'),
    url(r'^assignments/(?P<pk>\d+)/full_testscript/$', frontend.FullScriptView.as_view(), name='full_testscript'),
    url(r'^assignments/(?P<pk>\d+)/description_file/$', frontend.DescriptionFileView.as_view(),
        name='assignment_description_file'),
    ...
    url(r'^submission/(?P<pk>\d+)/attachment_file/$', frontend.AttachmentFileView.as_view(),
        name='submission_attachment_file'),
    ...
    url(r'^mergeusers/(?P<primary_pk>\d+)/(?P<secondary_pk>\d+)/$', backend.MergeUsersView.as_view(),
        name='mergeusers'),
