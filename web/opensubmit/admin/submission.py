...
class SubmissionAdmin(ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Grading',
         {'fields': (('grading', 'grading_status', 'notify_student'), 'grading_notes', 'grading_file'), }),
    )
    ...
    notify_student.short_description = ""
    ...
    def _render_test_result(self, result_obj, enabled, show_student_data):
        if not result_obj:
            ...
            return format_html(text + "<div style='font-size:80%'><br/>(Generated by {0})</div>", result_obj.machine)
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        pseudo_fields = ('file_link', 'validationtest_result_student', 'validationtest_result_tutor', 'fulltest_result',
                         'grading_status', 'assignment_info', 'modified', 'notify_student')
        if obj:
