...
def console_script(fsroot=''):
    ...
    parser_configcreate.add_argument('--admin_email', default=os.environ.get('ADMIN_EMAIL', 'openspace@h-da.de'), help='eMail of the administrator, shown in privacy policy, impress and backend.')
